          ...
          {timeline.map((item, index) => (
            <View key={item.id} className="flex-row items-start mb-5 last:mb-0">
              ...
              <View className="flex-1">
                ...
                {/* Status Details */}
                <View className={`rounded-lg p-3 border ${item.status === 'completed' ? 'bg-green-50 border-green-200' :
                  ...
                  <View className="flex-row items-center mb-2">
                    ...
                    />
                    <Text className={`ml-2 font-semibold text-sm ${item.status === 'completed' ? 'text-green-800' :
                        item.status === 'in-progress' ? 'text-orange-800' : 'text-gray-700'
                      }`}>
                      {item.details.message}
                    </Text>
                  </View>
                  <Text className={`text-sm leading-4 ${item.status === 'completed' ? 'text-green-700' :
